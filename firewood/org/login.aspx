<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="firewood.org.login" %>
...
<head>
    ...
    <![endif]-->
    <title>社团/组织后台登录 - 柴火 | 学生活动发布平台</title>
                ...
                <div class="center">
                    <form class="form-horizontal" runat="server">
                        <div class="form-group">
                            <label class="col-md-4 control-label">社团名称</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-6 control-label">
                                <a href="alert('请与光华园网站管理员联系')" title="忘记密码">忘记密码</a>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
